...
function Login() {
  ...
  return (
    <div className="w-full sm:w-3/4 md:w-1/2 h-screen flex flex-col justify-center items-center bg-white border rounded-none sm:rounded-tr-full sm:rounded-br-full p-6 sm:p-10 shadow-lg mx-auto sm:mx-0">
      {/* Welcome Text */}
      <div className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center space-y-2 mb-8 sm:mb-10 animate-fade-in">
        <h1>Welcome</h1>
        <h1>to</h1>
        <h1>Time Capsule</h1>
      </div>
      ...
      <Button
        variant="outline"
        className="text-lg sm:text-xl font-semibold px-8 sm:px-10 py-5 sm:py-6 hover:bg-purple-600 hover:text-white transition-all duration-300"
        onClick={handleLoginOpen}
      >
        Login / Signup
      </Button>
